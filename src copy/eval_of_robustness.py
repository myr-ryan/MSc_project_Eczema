# This is created by Zihao Wang, modified by Yingrui Ma.
import os
...
def main():
	...
	OUTPUT_DIR = os.path.join(PROJ_DIR, 'output_trained_on_TLA')
	...
	EVAL_DIR = os.path.join(OUTPUT_DIR, 'evaluations/' + SEGMENTATION + '_seg/robustness/new_method')
