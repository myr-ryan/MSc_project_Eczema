...
def plot_errorbar(x1, xerr1, evaluation_type, plot_index, savefile=False):
    ...
    y5 = ['TLA+DA']
    y6 = ['S+T+DA']
    # y2 = np.linspace(1, 4, num=2)
    # y3 = np.linspace(2, 5, num=2)
    axs[plot_index].errorbar([x1[0]], y1, ecolor='blue', fmt='ob', xerr=[xerr1[0]])
    axs[plot_index].errorbar([x1[1]], y2, ecolor='black', fmt='ok', xerr=[xerr1[1]])
    axs[plot_index].errorbar([x1[2]], y3, ecolor='red', fmt='or', xerr=[xerr1[2]])
    # axs[plot_index].set_yticklabels(['S+T', 'S+T+DA'], minor=False)
    axs[plot_index].errorbar([x1[3]], y4, ecolor='blue', fmt='ob', xerr=[xerr1[3]])
    axs[plot_index].errorbar([x1[4]], y5, ecolor='black', fmt='ok', xerr=[xerr1[4]])
    axs[plot_index].errorbar([x1[5]], y6, ecolor='red', fmt='or', xerr=[xerr1[5]])
    ...
    axs[plot_index].legend([evaluation_type + ' on SWET', evaluation_type + ' on TLA', evaluation_type + ' on S+T'], fontsize=15)
...
recall_x_S = [mean_SS[0], mean_TT[0], mean_STST[0], mean_aug_SS[0], mean_aug_TT[0], mean_aug_STST[0]]
...
recall_xerr_S = [se_SS[0], se_TT[0], se_STST[0], se_aug_SS[0], se_aug_TT[0], se_aug_STST[0]]
...
precision_x_S = [mean_SS[1], mean_TT[1], mean_STST[1], mean_aug_SS[1], mean_aug_TT[1], mean_aug_STST[1]]
...
precision_xerr_S = [se_SS[1], se_TT[1], se_STST[1], se_aug_SS[1], se_aug_TT[1], se_aug_STST[1]]
...
f1_x_S = [mean_SS[2], mean_TT[2], mean_STST[2], mean_aug_SS[2], mean_aug_TT[2], mean_aug_STST[2]]
...
f1_xerr_S = [se_SS[2], se_TT[2], se_STST[2], se_aug_SS[2], se_aug_TT[2], se_aug_STST[2]]
...
acc_x_S = [mean_SS[3], mean_TT[3], mean_STST[3], mean_aug_SS[3], mean_aug_TT[3], mean_aug_STST[3]]
...
acc_xerr_S = [se_SS[3], se_TT[3], se_STST[3], se_aug_SS[3], se_aug_TT[3], se_aug_STST[3]]
